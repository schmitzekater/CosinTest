<div class="nav" role="navigation">
    <ul class="list-group">
        ...
        <g:if test="${controllerName && !controllerName.equalsIgnoreCase('common') && !controllerName.equalsIgnoreCase('login')}">
            <sec:ifLoggedIn>
                <li class="list-group-item"><g:link class="list" action="list"><g:message
                        code="${controllerName}.label"/> <g:message code="nav.list.label"/></g:link></li>
                <sec:ifAllGranted roles="ROLE_CREATE">
                    <li class="list-group-item"><g:link class="create" action="create"><g:message
                            code="nav.new.label"/> <g:message code="${controllerName}.label"/></g:link></li>
                </sec:ifAllGranted>
